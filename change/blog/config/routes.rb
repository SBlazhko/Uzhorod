Rails.application.routes.draw do
  ...
  get 'chekcemail', to: 'registrations#chekcemail'
  get 'users', to: 'registrations#index'
  get 'user/:id', to: 'registrations#show', as: 'user'
  post 'user/:id/follow', to: 'sessions#create_following', as: 'follow'
  delete 'user/:id/unfollow', to: 'sessions#destroy_following', as: 'unfollow'
